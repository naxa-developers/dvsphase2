...
urlpatterns = [
    ...
    path(
        "program-delete/<int:pk>", views.ProgramDelete.as_view(), name="program-delete"
    ),
    ...
    path(
        "partner-delete/<int:pk>", views.PartnerDelete.as_view(), name="partner-delete"
    ),
    ...
    path(
        ...
        views.PartnerContactList.as_view(),
        name="partner-contact-list",
    ),
    path(
        "partner-contact-add/<int:id>",
        views.AddPartnerContact,
        name="partner-contact-add",
    ),
    path(
        "partner-contact-edit/<int:pk>",
        views.PartnerContactUpdate.as_view(),
        name="partner-contact-edit",
    ),
    path(
        "partner-contact-delete/<int:pk>",
        views.PartnerContactDelete.as_view(),
    ...
    path(
        "subsector-edit/<int:pk>",
        views.SubSectorUpdate.as_view(),
        name="subsector-edit",
    ),
    path(
        "subsector-delete/<int:pk>",
        views.SubSectorDelete.as_view(),
        name="subsector-delete",
    ),
    path("marker-list/", views.MarkerList.as_view(), name="marker-list"),
    path(
        "marker-cat-add/", views.MarkerCategoryCreate.as_view(), name="marker-cat-add"
    ),
    path(
        "marker-cat-edit/<int:pk>",
        views.MarkerCategoryUpdate.as_view(),
        name="marker-cat-edit",
    ),
    path(
        "marker-cat-delete/<int:pk>",
        views.MarkerCategoryDelete.as_view(),
        name="marker-cat-delete",
    ),
    ...
    path(
        "markervalue-edit/<int:pk>",
        views.MarkerValueUpdate.as_view(),
        name="markervalue-edit",
    ),
    path(
        "markervalue-delete/<int:pk>",
        views.MarkerValueDelete.as_view(),
        name="markervalue-delete",
    ),
    ...
    path(
        "indicator-edit/<int:pk>",
        views.IndicatorUpdate.as_view(),
        name="indicator-edit",
    ),
    path(
        "indicator-delete/<int:pk>",
        views.IndicatorDelete.as_view(),
    ...
    path(
        "province-edit/<int:pk>", views.ProvinceUpdate.as_view(), name="province-edit"
    ),
    path(
        "province-delete/<int:pk>",
    ...
    path(
        "district-edit/<int:pk>", views.DistrictUpdate.as_view(), name="district-edit"
    ),
    path("palika-edit/<int:pk>", views.PalilkaUpdate.as_view(), name="palika-edit"),
    path(
        "district-delete/<int:pk>",
        views.DistrictDelete.as_view(),
    ...
    path(
        "project-delete/<int:pk>", views.ProjectDelete.as_view(), name="project-delete"
    ),
    ...
    path(
        "permission-edit/<int:pk>",
        views.PermissionUpdate.as_view(),
        name="permission-edit",
    ),
    path(
        "permission-delete/<int:pk>",
        views.PermissionDelete.as_view(),
    ...
    path(
        "about-us-edit/<int:pk>", views.AboutUsUpdate.as_view(), name="about-us-update"
    ),
    path(
        "about-us-delete/<int:pk>",
        views.AboutUsDelete.as_view(),
    ...
    path(
        "contact-us-edit/<int:pk>",
        views.ContactUsUpdate.as_view(),
