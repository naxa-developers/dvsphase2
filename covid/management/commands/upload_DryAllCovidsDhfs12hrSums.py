...
from covid.models import DryAllCovidsDhfs12hrSums
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            for row in range(0, upper_range):
                ...
                DryAllCovidsDhfs12hrSums.objects.create(
                    ...
                    data='DryAllCovidsDhfs12hrSums'
                )
                print(row, 'DryAllCovidsDhfs12hrSums object successfully created')
