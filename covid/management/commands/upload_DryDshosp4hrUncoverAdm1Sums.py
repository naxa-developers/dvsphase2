...
from covid.models import DryDshosp4hrUncoveredAdm1Sums
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            for row in range(0, upper_range):
                ...
                DryDshosp4hrUncoveredAdm1Sums.objects.create(
                    ...
                    data='DryDshosp4hrUncoveredAdm1Sums'
                )
                print(row, 'DryDshosp4hrUncoveredAdm1Sums object successfully created')
