...
from covid.models import DryAllCovidsDhfs4hrSums
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            for row in range(0, upper_range):
                ...
                DryAllCovidsDhfs4hrSums.objects.create(
                    ...
                    data='DryAllCovidsDhfs4hrSums'
                )
                print(row, 'DryAllCovidsDhfs4hrSums object successfully created')
