...
from covid.models import DryDshosp12hrUncoveredAdm1Sums
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            for row in range(0, upper_range):
                ...
                DryDshosp12hrUncoveredAdm1Sums.objects.create(
                    ...
                    data='DryDshosp12hrUncoveredAdm1Sums'
                )
                print(row, 'DryDshosp12hrUncoveredAdm1Sums object successfully created')
