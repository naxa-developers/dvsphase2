...
from covid.models import DryDshosp12hrSums
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            for row in range(0, upper_range):
                ...
                DryDshosp12hrSums.objects.create(
                    ...
                    data='DryDshosp12hrSums'
                )
                print(row, 'DryDshosp12hrSums object successfully created')
