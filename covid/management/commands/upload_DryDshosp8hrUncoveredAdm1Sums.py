...
from covid.models import DryDshosp8hrUncoveredAdm1Sums
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            for row in range(0, upper_range):
                ...
                DryDshosp8hrUncoveredAdm1Sums.objects.create(
                    ...
                    data='DryDshosp8hrUncoveredAdm1Sums'
                )
                print(row, 'DryDshosp8hrUncoveredAdm1Sums object successfully created')
