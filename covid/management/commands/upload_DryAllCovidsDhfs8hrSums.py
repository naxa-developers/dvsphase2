...
from covid.models import DryAllCovidsDhfs8hrSums
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            for row in range(0, upper_range):
                ...
                DryAllCovidsDhfs8hrSums.objects.create(
                    ...
                    data='DryAllCovidsDhfs8hrSums'
                )
                print(row, 'DryAllCovidsDhfs8hrSums object successfully created')
