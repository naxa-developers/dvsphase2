...
from covid.models import DryAllCovidsDhfs8hrUncoveredAdm1Sums
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            for row in range(0, upper_range):
                ...
                DryAllCovidsDhfs8hrUncoveredAdm1Sums.objects.create(
                    ...
                    data='DryAllCovidsDhfs8hrUncoveredAdm1Sums'
                )
                print(row, 'DryAllCovidsDhfs8hrUncoveredAdm1Sums object successfully created')
