...
from covid.models import DryAllCovidsDhfs4hrUncoveredAdm1Sums
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            for row in range(0, upper_range):
                ...
                DryAllCovidsDhfs4hrUncoveredAdm1Sums.objects.create(
                    ...
                    data='DryAllCovidsDhfs4hrUncoveredAdm1Sums'
                )
                print(row, 'DryAllCovidsDhfs4hrUncoveredAdm1Sums object successfully created')
